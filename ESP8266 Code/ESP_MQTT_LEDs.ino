...
const char* ssid = "CARLisBAD"; //type your WIFI information inside the quotes
const char* password = "yourmomma";
const char* mqtt_server = "192.168.1.236";
const char* mqtt_username = "homeassistant";
const char* mqtt_password = "sdrk!fK9&d[A";
const int mqtt_port = 1883;



/**************************** FOR OTA **************************************************/
#define SENSORNAME "gwenLED" //change this to whatever you want to call your device
#define OTApassword "GwenLEDPass!" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;



/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "leds/gwenLED";
const char* light_set_topic = "leds/gwenLED/set";
